...
# Output: key : value, key:value, etc..
...
# Tuple is the key, 4 is the value. key has to stay the same value. a list: values can change- put in order. Dictonary is put in randomly, use key to pull it out
...
#can't use list as key, convert to a tuple
...
#stop and access: raise SystemExit (to kill code)

#sort function not in python 3
