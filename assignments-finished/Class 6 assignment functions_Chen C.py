...
# Variable for mass in units of g.
########################################
M = 2.04

# Variable for volume in units of ml.
##############################################
V = 1.07

# Solve for density in units of g/ml.
###################
P = M/V
print(P, "g/ml") 
...
# Variable for current in units of amperes.
########################################
I = 1.9

# Variable for resistance in units of ohms.
##############################################
R = 8.7

# Solve for voltage across the conductor in units of volts.
###################
V = I*R
print (V, "volts")
...
##################################################################
# Class 6 assignment
# 1)Convert your equations from the week 3 assignment to functions
##################################################################
#########################
# Liquid density equation
#########################
def LiquidDensityEquation(P, M, V): 
	P = M/V
	print("Liquid density from function:", P, "g/ml")
	return P
####################
# Ohm's law equation
####################
def OhmLawequation(V, I, R): 
	V = I*R
	print("Voltage from function:", V, "volts")
	return V
